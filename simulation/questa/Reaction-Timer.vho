...
-- reset	=>  Location: PIN_AF8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \prescaler|SW_reg[1]~feeder_combout\ : std_logic;
SIGNAL \prescaler|Equal0~0_combout\ : std_logic;
SIGNAL \prescaler|counter[4]~DUPLICATE_q\ : std_logic;
...
SIGNAL \prescaler|counter[2]~DUPLICATE_q\ : std_logic;
...
SIGNAL \fsm_inst|key_prev_state~0_combout\ : std_logic;
SIGNAL \fsm_inst|key_prev_state~q\ : std_logic;
...
SIGNAL \fsm_inst|current_state.LatchValue~feeder_combout\ : std_logic;
SIGNAL \fsm_inst|current_state.LatchValue~DUPLICATE_q\ : std_logic;
...
SIGNAL \fsm_inst|latched_clk_B_p1[1]~reg0feeder_combout\ : std_logic;
...
SIGNAL \fsm_inst|latched_clk_A_p1[1]~reg0feeder_combout\ : std_logic;
...
SIGNAL \fsm_inst|latched_clk_A_p1[0]~reg0feeder_combout\ : std_logic;
...
SIGNAL \fsm_inst|ALT_INV_current_state.LatchValue~DUPLICATE_q\ : std_logic;
SIGNAL \prescaler|ALT_INV_counter[2]~DUPLICATE_q\ : std_logic;
SIGNAL \prescaler|ALT_INV_counter[4]~DUPLICATE_q\ : std_logic;
...
SIGNAL \fsm_inst|ALT_INV_next_state.Setup~q\ : std_logic;
...
SIGNAL \fsm_inst|ALT_INV_key_prev_state~q\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\fsm_inst|ALT_INV_current_state.LatchValue~DUPLICATE_q\ <= NOT \fsm_inst|current_state.LatchValue~DUPLICATE_q\;
\prescaler|ALT_INV_counter[2]~DUPLICATE_q\ <= NOT \prescaler|counter[2]~DUPLICATE_q\;
\prescaler|ALT_INV_counter[4]~DUPLICATE_q\ <= NOT \prescaler|counter[4]~DUPLICATE_q\;
...
\fsm_inst|ALT_INV_next_state.Setup~q\ <= NOT \fsm_inst|next_state.Setup~q\;
...
\fsm_inst|ALT_INV_key_prev_state~q\ <= NOT \fsm_inst|key_prev_state~q\;
...
-- Equation(s):
-- \prescaler|Mux5~0_combout\ = ( \SW[0]~input_o\ & ( (\SW[1]~input_o\) # (\SW[2]~input_o\) ) ) # ( !\SW[0]~input_o\ & ( (!\SW[1]~input_o\) # (\SW[2]~input_o\) ) )
...
\prescaler|SW_reg[1]~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \prescaler|SW_reg[1]~feeder_combout\ = ( \SW[1]~input_o\ )
...
PORT MAP (
	...
	combout => \prescaler|SW_reg[1]~feeder_combout\);
...
PORT MAP (
	clk => \CLOCK_50~inputCLKENA0_outclk\,
	d => \prescaler|SW_reg[1]~feeder_combout\,
	ena => \prescaler|Equal0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \prescaler|Equal0~0_combout\ = ( \prescaler|SW_reg\(0) & ( \prescaler|SW_reg\(1) & ( (!\SW[0]~input_o\) # ((!\SW[1]~input_o\) # (!\prescaler|SW_reg\(2) $ (!\SW[2]~input_o\))) ) ) ) # ( !\prescaler|SW_reg\(0) & ( \prescaler|SW_reg\(1) & ( 
-- ((!\SW[1]~input_o\) # (!\prescaler|SW_reg\(2) $ (!\SW[2]~input_o\))) # (\SW[0]~input_o\) ) ) ) # ( \prescaler|SW_reg\(0) & ( !\prescaler|SW_reg\(1) & ( (!\SW[0]~input_o\) # ((!\prescaler|SW_reg\(2) $ (!\SW[2]~input_o\)) # (\SW[1]~input_o\)) ) ) ) # ( 
-- !\prescaler|SW_reg\(0) & ( !\prescaler|SW_reg\(1) & ( ((!\prescaler|SW_reg\(2) $ (!\SW[2]~input_o\)) # (\SW[1]~input_o\)) # (\SW[0]~input_o\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111111111110111101111111111101111011111111111011110111111111110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \prescaler|ALT_INV_SW_reg\(0),
...
\prescaler|counter[4]~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \prescaler|counter[4]~DUPLICATE_q\);
...
-- Equation(s):
-- \prescaler|Mux3~0_combout\ = ( \SW[2]~input_o\ ) # ( !\SW[2]~input_o\ & ( (!\SW[0]~input_o\) # (\SW[1]~input_o\) ) )
...
-- Equation(s):
-- \prescaler|Equal1~2_combout\ = ( \prescaler|counter\(2) & ( \prescaler|N\(15) & ( (!\prescaler|N\(0) & (\prescaler|counter\(13) & (\prescaler|counter[4]~DUPLICATE_q\ & !\prescaler|counter\(6)))) ) ) ) # ( !\prescaler|counter\(2) & ( \prescaler|N\(15) & ( 
-- (\prescaler|N\(0) & (!\prescaler|counter\(13) & (!\prescaler|counter[4]~DUPLICATE_q\ & !\prescaler|counter\(6)))) ) ) ) # ( \prescaler|counter\(2) & ( !\prescaler|N\(15) & ( (!\prescaler|N\(0) & (\prescaler|counter\(13) & 
-- (\prescaler|counter[4]~DUPLICATE_q\ & \prescaler|counter\(6)))) ) ) ) # ( !\prescaler|counter\(2) & ( !\prescaler|N\(15) & ( (\prescaler|N\(0) & (!\prescaler|counter\(13) & (!\prescaler|counter[4]~DUPLICATE_q\ & \prescaler|counter\(6)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000001000000000000000000001001000000000000000000001000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \prescaler|ALT_INV_N\(0),
	datab => \prescaler|ALT_INV_counter\(13),
	datac => \prescaler|ALT_INV_counter[4]~DUPLICATE_q\,
...
-- Equation(s):
-- \prescaler|Equal1~0_combout\ = ( !\prescaler|counter\(9) & ( !\prescaler|counter\(10) & ( (!\prescaler|counter\(7) & (!\prescaler|counter\(8) & (!\prescaler|N\(0) $ (!\prescaler|counter\(0))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100000010000000000000000000000000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \prescaler|ALT_INV_N\(0),
...
-- Equation(s):
-- \prescaler|Mux4~0_combout\ = ( \SW[0]~input_o\ & ( (\SW[1]~input_o\) # (\SW[2]~input_o\) ) ) # ( !\SW[0]~input_o\ & ( !\SW[2]~input_o\ $ (\SW[1]~input_o\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1001100110011001100110011001100101110111011101110111011101110111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_SW[2]~input_o\,
...
-- Equation(s):
-- \prescaler|Equal1~1_combout\ = ( \prescaler|counter\(5) & ( \prescaler|counter\(12) & ( (!\prescaler|N\(12) & (\prescaler|counter\(14) & (\prescaler|counter\(3) & \prescaler|counter\(1)))) ) ) ) # ( !\prescaler|counter\(5) & ( !\prescaler|counter\(12) & ( 
-- (\prescaler|N\(12) & (!\prescaler|counter\(14) & (!\prescaler|counter\(3) & !\prescaler|counter\(1)))) ) ) )
...
PORT MAP (
	...
	datad => \prescaler|ALT_INV_counter\(1),
	datae => \prescaler|ALT_INV_counter\(5),
	dataf => \prescaler|ALT_INV_counter\(12),
...
-- Equation(s):
-- \prescaler|Add0~21_sumout\ = SUM(( \prescaler|counter[22]~DUPLICATE_q\ ) + ( GND ) + ( \prescaler|Add0~18\ ))
-- \prescaler|Add0~22\ = CARRY(( \prescaler|counter[22]~DUPLICATE_q\ ) + ( GND ) + ( \prescaler|Add0~18\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \prescaler|ALT_INV_counter[22]~DUPLICATE_q\,
...
-- Equation(s):
-- \prescaler|Equal1~4_combout\ = ( \prescaler|counter\(17) & ( (!\prescaler|N\(17) & (\prescaler|counter\(23) & (!\prescaler|counter\(18) $ (\prescaler|N\(18))))) ) ) # ( !\prescaler|counter\(17) & ( (\prescaler|N\(17) & (!\prescaler|counter\(23) & 
-- (!\prescaler|counter\(18) $ (\prescaler|N\(18))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100000000000100001000000000001001000000000001000010000000000010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \prescaler|Mux2~0_combout\ = ( !\SW[2]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[0]~input_o\ ) ) )
...
-- Equation(s):
-- \prescaler|Equal1~3_combout\ = ( \prescaler|counter\(11) & ( \prescaler|N\(15) & ( (\prescaler|N\(11) & (!\prescaler|counter\(15) & (\prescaler|counter[24]~DUPLICATE_q\ & \prescaler|counter\(16)))) ) ) ) # ( !\prescaler|counter\(11) & ( \prescaler|N\(15) 
-- & ( (!\prescaler|N\(11) & (!\prescaler|counter\(15) & (!\prescaler|counter[24]~DUPLICATE_q\ & !\prescaler|counter\(16)))) ) ) ) # ( \prescaler|counter\(11) & ( !\prescaler|N\(15) & ( (\prescaler|N\(11) & (\prescaler|counter\(15) & 
-- (\prescaler|counter[24]~DUPLICATE_q\ & \prescaler|counter\(16)))) ) ) ) # ( !\prescaler|counter\(11) & ( !\prescaler|N\(15) & ( (!\prescaler|N\(11) & (\prescaler|counter\(15) & (!\prescaler|counter[24]~DUPLICATE_q\ & !\prescaler|counter\(16)))) ) ) )
...
-- Equation(s):
-- \prescaler|Equal1~5_combout\ = ( \prescaler|N\(12) & ( (!\prescaler|counter[19]~DUPLICATE_q\ & (!\prescaler|counter\(20) & (!\prescaler|counter\(21) & !\prescaler|counter[22]~DUPLICATE_q\))) ) ) # ( !\prescaler|N\(12) & ( 
-- (\prescaler|counter[19]~DUPLICATE_q\ & (\prescaler|counter\(20) & (\prescaler|counter\(21) & \prescaler|counter[22]~DUPLICATE_q\))) ) )
...
PORT MAP (
	...
	datad => \prescaler|ALT_INV_counter[22]~DUPLICATE_q\,
	dataf => \prescaler|ALT_INV_N\(12),
	combout => \prescaler|Equal1~5_combout\);

-- Location: LABCELL_X81_Y10_N12
\prescaler|Equal1~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \prescaler|Equal1~6_combout\ = ( \prescaler|Equal1~3_combout\ & ( \prescaler|Equal1~5_combout\ & ( (\prescaler|Equal1~2_combout\ & (\prescaler|Equal1~0_combout\ & (\prescaler|Equal1~1_combout\ & \prescaler|Equal1~4_combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \prescaler|ALT_INV_Equal1~2_combout\,
	datab => \prescaler|ALT_INV_Equal1~0_combout\,
	datac => \prescaler|ALT_INV_Equal1~1_combout\,
	datad => \prescaler|ALT_INV_Equal1~4_combout\,
	datae => \prescaler|ALT_INV_Equal1~3_combout\,
	dataf => \prescaler|ALT_INV_Equal1~5_combout\,
...
-- Equation(s):
-- \prescaler|Add0~73_sumout\ = SUM(( \prescaler|counter[1]~DUPLICATE_q\ ) + ( GND ) + ( \prescaler|Add0~54\ ))
-- \prescaler|Add0~74\ = CARRY(( \prescaler|counter[1]~DUPLICATE_q\ ) + ( GND ) + ( \prescaler|Add0~54\ ))
...
-- pragma translate_on
PORT MAP (
	dataa => \prescaler|ALT_INV_counter[1]~DUPLICATE_q\,
...
-- Equation(s):
-- \prescaler|Add0~89_sumout\ = SUM(( \prescaler|counter[2]~DUPLICATE_q\ ) + ( GND ) + ( \prescaler|Add0~74\ ))
-- \prescaler|Add0~90\ = CARRY(( \prescaler|counter[2]~DUPLICATE_q\ ) + ( GND ) + ( \prescaler|Add0~74\ ))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \prescaler|counter[2]~DUPLICATE_q\);
...
-- Equation(s):
-- \prescaler|Add0~37_sumout\ = SUM(( \prescaler|counter[10]~DUPLICATE_q\ ) + ( GND ) + ( \prescaler|Add0~42\ ))
-- \prescaler|Add0~38\ = CARRY(( \prescaler|counter[10]~DUPLICATE_q\ ) + ( GND ) + ( \prescaler|Add0~42\ ))
...
-- pragma translate_on
PORT MAP (
	datad => \prescaler|ALT_INV_counter[10]~DUPLICATE_q\,
...
-- pragma translate_on
PORT MAP (
	datad => \prescaler|ALT_INV_counter\(12),
...
-- pragma translate_on
PORT MAP (
	datad => \prescaler|ALT_INV_counter\(13),
...
PORT MAP (
	clk => \CLOCK_50~inputCLKENA0_outclk\,
	asdata => \prescaler|Add0~77_sumout\,
	sclr => \prescaler|Equal1~6_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	clk => \CLOCK_50~inputCLKENA0_outclk\,
	asdata => \prescaler|Add0~57_sumout\,
	sclr => \prescaler|Equal1~6_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	...
	d => \fsm_inst|current_state.LatchValue~feeder_combout\,
	clrn => \KEY[3]~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\fsm_inst|key_prev_state~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \fsm_inst|key_prev_state~0_combout\ = ( \fsm_inst|key_prev_state~q\ & ( \fsm_inst|current_state.LatchValue~q\ & ( (!\KEY[3]~input_o\) # (\KEY[0]~input_o\) ) ) ) # ( !\fsm_inst|key_prev_state~q\ & ( \fsm_inst|current_state.LatchValue~q\ & ( 
-- (\KEY[3]~input_o\ & \KEY[0]~input_o\) ) ) ) # ( \fsm_inst|key_prev_state~q\ & ( !\fsm_inst|current_state.LatchValue~q\ ) )
...
PORT MAP (
	...
	datae => \fsm_inst|ALT_INV_key_prev_state~q\,
	dataf => \fsm_inst|ALT_INV_current_state.LatchValue~q\,
	combout => \fsm_inst|key_prev_state~0_combout\);

-- Location: FF_X57_Y8_N44
\fsm_inst|key_prev_state\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~inputCLKENA0_outclk\,
	d => \fsm_inst|key_prev_state~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \fsm_inst|key_prev_state~q\);

-- Location: LABCELL_X57_Y8_N33
\fsm_inst|next_state.Setup~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \fsm_inst|next_state.Setup~0_combout\ = ( \fsm_inst|next_state.Setup~q\ & ( \fsm_inst|key_prev_state~q\ ) ) # ( !\fsm_inst|next_state.Setup~q\ & ( \fsm_inst|key_prev_state~q\ & ( (\KEY[3]~input_o\ & !\fsm_inst|current_state.LatchValue~q\) ) ) ) # ( 
-- \fsm_inst|next_state.Setup~q\ & ( !\fsm_inst|key_prev_state~q\ ) ) # ( !\fsm_inst|next_state.Setup~q\ & ( !\fsm_inst|key_prev_state~q\ & ( (\KEY[3]~input_o\ & ((!\fsm_inst|current_state.LatchValue~q\) # (\KEY[0]~input_o\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100010001111111111111111100110011000000001111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \fsm_inst|ALT_INV_next_state.Setup~q\,
	dataf => \fsm_inst|ALT_INV_key_prev_state~q\,
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~inputCLKENA0_outclk\,
	d => \fsm_inst|next_state.Setup~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \fsm_inst|Selector33~0_combout\ = ( \fsm_inst|next_state.WaitForStart~q\ & ( \fsm_inst|key_prev_state~q\ & ( (!\fsm_inst|current_state.Setup~q\) # (\fsm_inst|current_state.LatchValue~DUPLICATE_q\) ) ) ) # ( !\fsm_inst|next_state.WaitForStart~q\ & ( 
-- \fsm_inst|key_prev_state~q\ & ( !\fsm_inst|current_state.Setup~q\ ) ) ) # ( \fsm_inst|next_state.WaitForStart~q\ & ( !\fsm_inst|key_prev_state~q\ & ( (!\fsm_inst|current_state.Setup~q\) # ((!\KEY[0]~input_o\ & 
-- \fsm_inst|current_state.LatchValue~DUPLICATE_q\)) ) ) ) # ( !\fsm_inst|next_state.WaitForStart~q\ & ( !\fsm_inst|key_prev_state~q\ & ( !\fsm_inst|current_state.Setup~q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110011001100110011001110111011001100110011001100110011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_KEY[0]~input_o\,
	datab => \fsm_inst|ALT_INV_current_state.Setup~q\,
	datad => \fsm_inst|ALT_INV_current_state.LatchValue~DUPLICATE_q\,
	datae => \fsm_inst|ALT_INV_next_state.WaitForStart~q\,
	dataf => \fsm_inst|ALT_INV_key_prev_state~q\,
...
-- Equation(s):
-- \fsm_inst|Selector34~0_combout\ = ( \fsm_inst|next_state.LatchValue~q\ & ( \fsm_inst|key_prev_state~q\ & ( (\fsm_inst|current_state.LatchValue~q\) # (\fsm_inst|current_state.WaitForStart~q\) ) ) ) # ( !\fsm_inst|next_state.LatchValue~q\ & ( 
-- \fsm_inst|key_prev_state~q\ & ( \fsm_inst|current_state.WaitForStart~q\ ) ) ) # ( \fsm_inst|next_state.LatchValue~q\ & ( !\fsm_inst|key_prev_state~q\ & ( ((!\KEY[0]~input_o\ & \fsm_inst|current_state.LatchValue~q\)) # 
-- (\fsm_inst|current_state.WaitForStart~q\) ) ) ) # ( !\fsm_inst|next_state.LatchValue~q\ & ( !\fsm_inst|key_prev_state~q\ & ( \fsm_inst|current_state.WaitForStart~q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010101010101011101110101010101010101010101010111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
\fsm_inst|current_state.LatchValue~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \fsm_inst|current_state.LatchValue~feeder_combout\ = \fsm_inst|next_state.LatchValue~q\
...
-- pragma translate_on
PORT MAP (
	datac => \fsm_inst|ALT_INV_next_state.LatchValue~q\,
	combout => \fsm_inst|current_state.LatchValue~feeder_combout\);

-- Location: FF_X57_Y8_N59
\fsm_inst|current_state.LatchValue~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \fsm_inst|current_state.LatchValue~DUPLICATE_q\);

-- Location: LABCELL_X57_Y8_N24
\fsm_inst|latched_clk_B_p1[3]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \fsm_inst|latched_clk_B_p1[3]~0_combout\ = ( \fsm_inst|current_state.LatchValue~DUPLICATE_q\ & ( !\fsm_inst|key_prev_state~q\ & ( \KEY[0]~input_o\ ) ) )
...
PORT MAP (
	dataa => \ALT_INV_KEY[0]~input_o\,
	datae => \fsm_inst|ALT_INV_current_state.LatchValue~DUPLICATE_q\,
	dataf => \fsm_inst|ALT_INV_key_prev_state~q\,
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~inputCLKENA0_outclk\,
	asdata => \prescaler|counter[17]~DUPLICATE_q\,
	clrn => \KEY[3]~input_o\,
	sload => VCC,
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~inputCLKENA0_outclk\,
	asdata => \prescaler|counter[19]~DUPLICATE_q\,
	clrn => \KEY[3]~input_o\,
	sload => VCC,
	ena => \fsm_inst|latched_clk_B_p1[3]~0_combout\,
	devclrn => ww_devclrn,
...
\fsm_inst|latched_clk_B_p1[1]~reg0feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \fsm_inst|latched_clk_B_p1[1]~reg0feeder_combout\ = ( \prescaler|counter\(18) )
...
PORT MAP (
	...
	combout => \fsm_inst|latched_clk_B_p1[1]~reg0feeder_combout\);
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~inputCLKENA0_outclk\,
	d => \fsm_inst|latched_clk_B_p1[1]~reg0feeder_combout\,
	clrn => \KEY[3]~input_o\,
	ena => \fsm_inst|latched_clk_B_p1[3]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0110001101100011011000110110001100001111000011110000111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \fsm_inst|ALT_INV_latched_clk_B_p1[0]~reg0_q\,
	datab => \fsm_inst|ALT_INV_latched_clk_B_p1[2]~reg0_q\,
...
-- Equation(s):
-- \fsm_inst|HEX2_inst|Mux5~0_combout\ = ( \fsm_inst|latched_clk_B_p1[3]~reg0_q\ & ( (\fsm_inst|latched_clk_B_p1[2]~reg0_q\) # (\fsm_inst|latched_clk_B_p1[1]~reg0_q\) ) ) # ( !\fsm_inst|latched_clk_B_p1[3]~reg0_q\ & ( (\fsm_inst|latched_clk_B_p1[2]~reg0_q\ & 
-- (!\fsm_inst|latched_clk_B_p1[0]~reg0_q\ $ (!\fsm_inst|latched_clk_B_p1[1]~reg0_q\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000001011010000011111111111100000000010110100000111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \fsm_inst|ALT_INV_latched_clk_B_p1[0]~reg0_q\,
	...
	datae => \fsm_inst|ALT_INV_latched_clk_B_p1[3]~reg0_q\,
...
-- & ( (\fsm_inst|latched_clk_B_p1[2]~reg0_q\ & \fsm_inst|latched_clk_B_p1[3]~reg0_q\) ) )
...
-- Equation(s):
-- \fsm_inst|HEX2_inst|Mux3~0_combout\ = ( \fsm_inst|latched_clk_B_p1[3]~reg0_q\ & ( \fsm_inst|latched_clk_B_p1[2]~reg0_q\ ) ) # ( !\fsm_inst|latched_clk_B_p1[3]~reg0_q\ & ( \fsm_inst|latched_clk_B_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[0]~reg0_q\ $ 
-- (\fsm_inst|latched_clk_B_p1[1]~reg0_q\) ) ) ) # ( \fsm_inst|latched_clk_B_p1[3]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[2]~reg0_q\ & ( (\fsm_inst|latched_clk_B_p1[1]~reg0_q\) # (\fsm_inst|latched_clk_B_p1[0]~reg0_q\) ) ) ) # ( 
-- !\fsm_inst|latched_clk_B_p1[3]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[2]~reg0_q\ & ( (\fsm_inst|latched_clk_B_p1[0]~reg0_q\ & !\fsm_inst|latched_clk_B_p1[1]~reg0_q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100000000001100111111111111001100001100111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \fsm_inst|ALT_INV_latched_clk_B_p1[0]~reg0_q\,
	datad => \fsm_inst|ALT_INV_latched_clk_B_p1[1]~reg0_q\,
	datae => \fsm_inst|ALT_INV_latched_clk_B_p1[3]~reg0_q\,
	dataf => \fsm_inst|ALT_INV_latched_clk_B_p1[2]~reg0_q\,
	combout => \fsm_inst|HEX2_inst|Mux3~0_combout\);

-- Location: LABCELL_X80_Y8_N21
\fsm_inst|HEX2_inst|Mux2~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \fsm_inst|HEX2_inst|Mux2~0_combout\ = ( \fsm_inst|latched_clk_B_p1[3]~reg0_q\ & ( \fsm_inst|latched_clk_B_p1[2]~reg0_q\ ) ) # ( !\fsm_inst|latched_clk_B_p1[3]~reg0_q\ & ( \fsm_inst|latched_clk_B_p1[2]~reg0_q\ & ( (!\fsm_inst|latched_clk_B_p1[1]~reg0_q\) # 
-- (\fsm_inst|latched_clk_B_p1[0]~reg0_q\) ) ) ) # ( \fsm_inst|latched_clk_B_p1[3]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[2]~reg0_q\ & ( (\fsm_inst|latched_clk_B_p1[0]~reg0_q\) # (\fsm_inst|latched_clk_B_p1[1]~reg0_q\) ) ) ) # ( 
-- !\fsm_inst|latched_clk_B_p1[3]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[2]~reg0_q\ & ( \fsm_inst|latched_clk_B_p1[0]~reg0_q\ ) ) )
...
-- Equation(s):
-- \fsm_inst|HEX2_inst|Mux1~0_combout\ = ( \fsm_inst|latched_clk_B_p1[2]~reg0_q\ & ( \fsm_inst|latched_clk_B_p1[0]~reg0_q\ & ( (\fsm_inst|latched_clk_B_p1[1]~reg0_q\) # (\fsm_inst|latched_clk_B_p1[3]~reg0_q\) ) ) ) # ( !\fsm_inst|latched_clk_B_p1[2]~reg0_q\ 
-- & ( \fsm_inst|latched_clk_B_p1[0]~reg0_q\ & ( (!\fsm_inst|latched_clk_B_p1[3]~reg0_q\) # (\fsm_inst|latched_clk_B_p1[1]~reg0_q\) ) ) ) # ( \fsm_inst|latched_clk_B_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[0]~reg0_q\ & ( 
-- \fsm_inst|latched_clk_B_p1[3]~reg0_q\ ) ) ) # ( !\fsm_inst|latched_clk_B_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[0]~reg0_q\ & ( \fsm_inst|latched_clk_B_p1[1]~reg0_q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100110011010101010101010110111011101110110111011101110111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \fsm_inst|ALT_INV_latched_clk_B_p1[3]~reg0_q\,
	datab => \fsm_inst|ALT_INV_latched_clk_B_p1[1]~reg0_q\,
	datae => \fsm_inst|ALT_INV_latched_clk_B_p1[2]~reg0_q\,
...
-- Equation(s):
-- \fsm_inst|HEX2_inst|Mux0~0_combout\ = ( \fsm_inst|latched_clk_B_p1[0]~reg0_q\ & ( \fsm_inst|latched_clk_B_p1[1]~reg0_q\ & ( (!\fsm_inst|latched_clk_B_p1[2]~reg0_q\ & !\fsm_inst|latched_clk_B_p1[3]~reg0_q\) ) ) ) # ( !\fsm_inst|latched_clk_B_p1[0]~reg0_q\ 
-- & ( \fsm_inst|latched_clk_B_p1[1]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[3]~reg0_q\ ) ) ) # ( \fsm_inst|latched_clk_B_p1[0]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[1]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[2]~reg0_q\ $ 
-- (!\fsm_inst|latched_clk_B_p1[3]~reg0_q\) ) ) ) # ( !\fsm_inst|latched_clk_B_p1[0]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[1]~reg0_q\ & ( !\fsm_inst|latched_clk_B_p1[2]~reg0_q\ $ (!\fsm_inst|latched_clk_B_p1[3]~reg0_q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101101001011010010110100101101011110000111100001010000010100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \fsm_inst|ALT_INV_latched_clk_B_p1[2]~reg0_q\,
	datac => \fsm_inst|ALT_INV_latched_clk_B_p1[3]~reg0_q\,
	datae => \fsm_inst|ALT_INV_latched_clk_B_p1[0]~reg0_q\,
	dataf => \fsm_inst|ALT_INV_latched_clk_B_p1[1]~reg0_q\,
...
\fsm_inst|latched_clk_A_p1[1]~reg0feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \fsm_inst|latched_clk_A_p1[1]~reg0feeder_combout\ = ( \prescaler|counter\(22) )
...
PORT MAP (
	...
	combout => \fsm_inst|latched_clk_A_p1[1]~reg0feeder_combout\);
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~inputCLKENA0_outclk\,
	d => \fsm_inst|latched_clk_A_p1[1]~reg0feeder_combout\,
	clrn => \KEY[3]~input_o\,
	ena => \fsm_inst|latched_clk_B_p1[3]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~inputCLKENA0_outclk\,
	asdata => \prescaler|counter[24]~DUPLICATE_q\,
	clrn => \KEY[3]~input_o\,
	sload => VCC,
	ena => \fsm_inst|latched_clk_B_p1[3]~0_combout\,
	devclrn => ww_devclrn,
...
\fsm_inst|latched_clk_A_p1[0]~reg0feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \fsm_inst|latched_clk_A_p1[0]~reg0feeder_combout\ = ( \prescaler|counter\(21) )
...
-- pragma translate_on
PORT MAP (
	dataf => \prescaler|ALT_INV_counter\(21),
	combout => \fsm_inst|latched_clk_A_p1[0]~reg0feeder_combout\);
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~inputCLKENA0_outclk\,
	d => \fsm_inst|latched_clk_A_p1[0]~reg0feeder_combout\,
	clrn => \KEY[3]~input_o\,
	ena => \fsm_inst|latched_clk_B_p1[3]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \fsm_inst|HEX3_inst|Mux6~0_combout\ = ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[3]~reg0_q\ ) ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ & 
-- ( !\fsm_inst|latched_clk_A_p1[1]~reg0_q\ $ (\fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) ) # ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( (!\fsm_inst|latched_clk_A_p1[1]~reg0_q\) # 
-- (\fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( (\fsm_inst|latched_clk_A_p1[1]~reg0_q\ & \fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \fsm_inst|ALT_INV_latched_clk_A_p1[1]~reg0_q\,
	datac => \fsm_inst|ALT_INV_latched_clk_A_p1[3]~reg0_q\,
	datae => \fsm_inst|ALT_INV_latched_clk_A_p1[2]~reg0_q\,
...
-- & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( (\fsm_inst|latched_clk_A_p1[1]~reg0_q\ & \fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) ) # ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( 
-- (\fsm_inst|latched_clk_A_p1[3]~reg0_q\) # (\fsm_inst|latched_clk_A_p1[1]~reg0_q\) ) ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( (\fsm_inst|latched_clk_A_p1[1]~reg0_q\ & 
-- \fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000110011001100111111111100000000001100111100110011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \fsm_inst|ALT_INV_latched_clk_A_p1[1]~reg0_q\,
...
-- Equation(s):
-- \fsm_inst|HEX3_inst|Mux4~0_combout\ = ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[3]~reg0_q\ ) ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ & 
-- ( (\fsm_inst|latched_clk_A_p1[1]~reg0_q\ & \fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) ) # ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[3]~reg0_q\ ) ) ) # ( 
-- !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[1]~reg0_q\ ) ) )
...
-- Equation(s):
-- \fsm_inst|HEX3_inst|Mux3~0_combout\ = ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( (\fsm_inst|latched_clk_A_p1[3]~reg0_q\) # (\fsm_inst|latched_clk_A_p1[1]~reg0_q\) ) ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ 
-- & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( (!\fsm_inst|latched_clk_A_p1[1]~reg0_q\) # (\fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) ) # ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( 
-- (!\fsm_inst|latched_clk_A_p1[1]~reg0_q\) # (\fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( (\fsm_inst|latched_clk_A_p1[1]~reg0_q\ & 
-- \fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000110011110011001111111111001100111111110011001111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \fsm_inst|ALT_INV_latched_clk_A_p1[1]~reg0_q\,
...
-- Equation(s):
-- \fsm_inst|HEX3_inst|Mux2~0_combout\ = ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ ) ) # ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ 
-- & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( (!\fsm_inst|latched_clk_A_p1[1]~reg0_q\) # (\fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001100000011110011111100111111111111111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \fsm_inst|ALT_INV_latched_clk_A_p1[1]~reg0_q\,
...
-- Equation(s):
-- \fsm_inst|HEX3_inst|Mux1~0_combout\ = ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( (\fsm_inst|latched_clk_A_p1[3]~reg0_q\) # (\fsm_inst|latched_clk_A_p1[1]~reg0_q\) ) ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ 
-- & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( (!\fsm_inst|latched_clk_A_p1[3]~reg0_q\) # (\fsm_inst|latched_clk_A_p1[1]~reg0_q\) ) ) ) # ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( 
-- \fsm_inst|latched_clk_A_p1[3]~reg0_q\ ) ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[1]~reg0_q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100110011000000001111111111111111001100110011001111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \fsm_inst|ALT_INV_latched_clk_A_p1[1]~reg0_q\,
...
-- Equation(s):
-- \fsm_inst|HEX3_inst|Mux0~0_combout\ = ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( (!\fsm_inst|latched_clk_A_p1[1]~reg0_q\ & !\fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ 
-- & ( \fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[1]~reg0_q\ $ (!\fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) ) # ( \fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( 
-- !\fsm_inst|latched_clk_A_p1[3]~reg0_q\ ) ) ) # ( !\fsm_inst|latched_clk_A_p1[2]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[0]~reg0_q\ & ( !\fsm_inst|latched_clk_A_p1[1]~reg0_q\ $ (!\fsm_inst|latched_clk_A_p1[3]~reg0_q\) ) ) )
...
-- Equation(s):
-- \fsm_inst|HEX4_inst|Mux6~0_combout\ = ( \prescaler|counter\(20) & ( (\prescaler|counter\(19)) # (\prescaler|counter\(18)) ) ) # ( !\prescaler|counter\(20) & ( (!\prescaler|counter\(18) & (!\prescaler|counter\(19) $ (!\prescaler|counter\(17)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000110011000000000011001100000000111111001111110011111100111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \fsm_inst|HEX4_inst|Mux5~0_combout\ = ( \prescaler|counter[17]~DUPLICATE_q\ & ( \prescaler|counter\(20) & ( (\prescaler|counter\(18)) # (\prescaler|counter\(19)) ) ) ) # ( !\prescaler|counter[17]~DUPLICATE_q\ & ( \prescaler|counter\(20) & ( 
-- (\prescaler|counter\(18)) # (\prescaler|counter\(19)) ) ) ) # ( \prescaler|counter[17]~DUPLICATE_q\ & ( !\prescaler|counter\(20) & ( (\prescaler|counter\(19) & !\prescaler|counter\(18)) ) ) ) # ( !\prescaler|counter[17]~DUPLICATE_q\ & ( 
-- !\prescaler|counter\(20) & ( (\prescaler|counter\(19) & \prescaler|counter\(18)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001100000011001100000011000000111111001111110011111100111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \prescaler|ALT_INV_counter\(19),
	datac => \prescaler|ALT_INV_counter\(18),
	datae => \prescaler|ALT_INV_counter[17]~DUPLICATE_q\,
	dataf => \prescaler|ALT_INV_counter\(20),
...
-- Equation(s):
-- \fsm_inst|HEX4_inst|Mux4~0_combout\ = ( \prescaler|counter\(19) & ( \prescaler|counter\(20) ) ) # ( !\prescaler|counter\(19) & ( (\prescaler|counter\(18) & ((!\prescaler|counter\(17)) # (\prescaler|counter\(20)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000110000001111000011000000111100000000111111110000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \fsm_inst|HEX4_inst|Mux3~0_combout\ = ( \prescaler|counter\(17) & ( \prescaler|counter\(20) ) ) # ( !\prescaler|counter\(17) & ( \prescaler|counter\(20) & ( (\prescaler|counter\(19)) # (\prescaler|counter\(18)) ) ) ) # ( \prescaler|counter\(17) & ( 
-- !\prescaler|counter\(20) & ( !\prescaler|counter\(18) $ (\prescaler|counter\(19)) ) ) ) # ( !\prescaler|counter\(17) & ( !\prescaler|counter\(20) & ( (!\prescaler|counter\(18) & \prescaler|counter\(19)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000110000001100110000111100001100111111001111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \prescaler|ALT_INV_counter\(18),
...
-- Equation(s):
-- \fsm_inst|HEX4_inst|Mux2~0_combout\ = ( \prescaler|counter[17]~DUPLICATE_q\ & ( \prescaler|counter\(20) ) ) # ( !\prescaler|counter[17]~DUPLICATE_q\ & ( \prescaler|counter\(20) & ( (\prescaler|counter\(19)) # (\prescaler|counter\(18)) ) ) ) # ( 
-- \prescaler|counter[17]~DUPLICATE_q\ & ( !\prescaler|counter\(20) ) ) # ( !\prescaler|counter[17]~DUPLICATE_q\ & ( !\prescaler|counter\(20) & ( (!\prescaler|counter\(18) & \prescaler|counter\(19)) ) ) )
...
-- Equation(s):
-- \fsm_inst|HEX4_inst|Mux1~0_combout\ = ( \prescaler|counter[17]~DUPLICATE_q\ & ( \prescaler|counter\(18) ) ) # ( !\prescaler|counter[17]~DUPLICATE_q\ & ( \prescaler|counter\(18) & ( (!\prescaler|counter\(19)) # (\prescaler|counter\(20)) ) ) ) # ( 
-- \prescaler|counter[17]~DUPLICATE_q\ & ( !\prescaler|counter\(18) & ( !\prescaler|counter\(19) $ (\prescaler|counter\(20)) ) ) ) # ( !\prescaler|counter[17]~DUPLICATE_q\ & ( !\prescaler|counter\(18) & ( (\prescaler|counter\(19) & \prescaler|counter\(20)) ) 
-- ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010100000101101001011010010110101111101011111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \fsm_inst|HEX4_inst|Mux0~0_combout\ = ( \prescaler|counter\(19) & ( (!\prescaler|counter\(20) & ((!\prescaler|counter[17]~DUPLICATE_q\) # (!\prescaler|counter\(18)))) ) ) # ( !\prescaler|counter\(19) & ( !\prescaler|counter\(20) $ 
...
-- pragma translate_on
PORT MAP (
	dataa => \prescaler|ALT_INV_counter[17]~DUPLICATE_q\,
	datab => \prescaler|ALT_INV_counter\(20),
	datac => \prescaler|ALT_INV_counter\(18),
...
-- Equation(s):
-- \fsm_inst|HEX5_inst|Mux6~0_combout\ = ( \prescaler|counter\(21) & ( !\prescaler|counter[24]~DUPLICATE_q\ $ (((\prescaler|counter\(23)) # (\prescaler|counter\(22)))) ) ) # ( !\prescaler|counter\(21) & ( (!\prescaler|counter\(22) & 
...
-- Equation(s):
-- \fsm_inst|HEX5_inst|Mux5~0_combout\ = ( \prescaler|counter\(23) & ( \prescaler|counter\(24) ) ) # ( !\prescaler|counter\(23) & ( \prescaler|counter\(24) & ( \prescaler|counter\(22) ) ) ) # ( \prescaler|counter\(23) & ( !\prescaler|counter\(24) & ( 
-- !\prescaler|counter\(22) $ (!\prescaler|counter\(21)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000011001100110011001010101010101011111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \prescaler|ALT_INV_counter\(22),
...
-- Equation(s):
-- \fsm_inst|HEX5_inst|Mux4~0_combout\ = ( \prescaler|counter\(23) & ( \prescaler|counter\(24) ) ) # ( !\prescaler|counter\(23) & ( \prescaler|counter\(24) & ( \prescaler|counter\(22) ) ) ) # ( !\prescaler|counter\(23) & ( !\prescaler|counter\(24) & ( 
-- (\prescaler|counter\(22) & !\prescaler|counter\(21)) ) ) )
...
-- Equation(s):
-- \fsm_inst|HEX5_inst|Mux3~0_combout\ = ( \prescaler|counter\(21) & ( \prescaler|counter\(24) ) ) # ( !\prescaler|counter\(21) & ( \prescaler|counter\(24) & ( (\prescaler|counter\(22)) # (\prescaler|counter\(23)) ) ) ) # ( \prescaler|counter\(21) & ( 
-- !\prescaler|counter\(24) & ( !\prescaler|counter\(23) $ (\prescaler|counter\(22)) ) ) ) # ( !\prescaler|counter\(21) & ( !\prescaler|counter\(24) & ( (\prescaler|counter\(23) & !\prescaler|counter\(22)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101000001010000101001011010010101011111010111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \fsm_inst|HEX5_inst|Mux2~0_combout\ = ( \prescaler|counter\(21) & ( \prescaler|counter\(24) ) ) # ( !\prescaler|counter\(21) & ( \prescaler|counter\(24) & ( (\prescaler|counter\(22)) # (\prescaler|counter\(23)) ) ) ) # ( \prescaler|counter\(21) & ( 
-- !\prescaler|counter\(24) ) ) # ( !\prescaler|counter\(21) & ( !\prescaler|counter\(24) & ( (\prescaler|counter\(23) & !\prescaler|counter\(22)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101000001010000111111111111111101011111010111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \prescaler|ALT_INV_counter\(23),
...
-- Equation(s):
-- \fsm_inst|HEX5_inst|Mux1~0_combout\ = ( \prescaler|counter\(23) & ( \prescaler|counter\(24) ) ) # ( !\prescaler|counter\(23) & ( \prescaler|counter\(24) & ( \prescaler|counter\(22) ) ) ) # ( \prescaler|counter\(23) & ( !\prescaler|counter\(24) & ( 
-- (\prescaler|counter\(22) & \prescaler|counter\(21)) ) ) ) # ( !\prescaler|counter\(23) & ( !\prescaler|counter\(24) & ( (\prescaler|counter\(21)) # (\prescaler|counter\(22)) ) ) )
...
-- Equation(s):
-- \fsm_inst|HEX5_inst|Mux0~0_combout\ = ( \prescaler|counter[24]~DUPLICATE_q\ & ( (!\prescaler|counter\(22) & !\prescaler|counter\(23)) ) ) # ( !\prescaler|counter[24]~DUPLICATE_q\ & ( (!\prescaler|counter\(22) & (\prescaler|counter\(23))) # 
-- (\prescaler|counter\(22) & ((!\prescaler|counter\(23)) # (!\prescaler|counter\(21)))) ) )
